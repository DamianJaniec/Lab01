namespace Lab01
{
    public class Samochod
    {
        ...
        public Samochod(string _marka, string _model, int _iloscDrzwi, int _pojemnoscSilnika, double _srednieSpalanie, string _nrRejestracyjny)
        {
            marka = _marka;
            model = _model;
            ...
            nrRejestracyjny = _nrRejestracyjny;
